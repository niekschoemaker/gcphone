...
MySQL.ready(function()
	MySQL.Async.execute(
		...
		{},
		function(result)
			print("[gcphone] removed: " .. json.encode(result))
		end
	)
end)
...
function addMessage(source, identifier, phone_number, message)
	...
	if otherIdentifier ~= nil then
		...
		local xPlayerOther = ESX.GetPlayerFromIdentifier(otherIdentifier)
		if xPlayerOther ~= nil then
			TriggerClientEvent("gcPhone:receiveMessage", xPlayerOther.source, tomess)
		end
	end
...
AddEventHandler('es:playerLoaded',function(source)
	...
	getOrGeneratePhoneNumber(sourcePlayer, identifier, function (myPhoneNumber)
		...
		TriggerLatentClientEvent("gcPhone:contactList", sourcePlayer, 100000, getContacts(identifier))
		TriggerLatentClientEvent("gcPhone:allMessage", sourcePlayer, 100000, getMessages(identifier))
	end)
end)
